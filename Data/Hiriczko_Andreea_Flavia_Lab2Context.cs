...
namespace Hiriczko_Andreea_Flavia_Lab2.Data
{
    public class Hiriczko_Andreea_Flavia_Lab2Context : DbContext
    {
        ...
        public DbSet<Hiriczko_Andreea_Flavia_Lab2.Models.Category> Category { get; set; }

        public DbSet<Hiriczko_Andreea_Flavia_Lab2.Models.Member> Member { get; set; }

        public DbSet<Hiriczko_Andreea_Flavia_Lab2.Models.Borrowing> Borrowing { get; set; }
    }
}
